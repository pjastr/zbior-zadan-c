...
Lista bez głowy to konstrukcja, w elementy znajdują się od samego początku listy. Jeśli lista bez głowy ma $n$ elementów, to do jej stworzenia potrzeba $n$ struktur. Pusta lista bez głowy to `NULL`. Lista w `main` powinna być przechowywana jako wskaźnik do struktury.

Lista z głową to konstrukcja, w której na początku znajduje się struktura (tzw. głowa) z niezainicjowaną wartością. Pusta lista z głową zawiera samą jedną strukturę, której następnik jest `NULL`. Przyjmuje się, że głowa zawsze istnieje, więc nie trzeba sprawdzać czy jest NULLem. Jeśli lista z głową ma $n$ elementów, to do jej stworzenia potrzeba $n+1$ struktur. Lista w `main` powinna być przechowywana jako wskaźnik do struktury.
...
15. Napisz funkcję `sumOddWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
16. Napisz funkcję `sumNegativeWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
17. Napisz funkcję `lastEvenWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
18. Napisz funkcję `lastPositiveWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
19. Napisz funkcję `removeFirstWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
20. Napisz funkcję `removeFirstWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
21. Napisz funkcję `removeLastWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
22. Napisz funkcję `removeLastWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
23. Napisz funkcję `removeSecondLastWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
24. Napisz funkcję `removeSecondLastWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
25. Napisz funkcję `removeAllWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
26. Napisz funkcję `removeAllWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
27. Napisz funkcję `printPerfectSquares`, która otrzymuje jako argument listę bez głowy o elementach typu:
...
28. Napisz funkcję `findMin`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
29. Napisz funkcję `duplicateLastWithoutHead`, która otrzymuje jako argument listę bez głowy o elementach typu:
...
30. Napisz funkcję `duplicateLastWithHead`, która otrzymuje jako argument listę z głową o elementach typu:
...
31. Napisz funkcję `equalLast`, która porównuje dwie listy z głową o elementach typu:
...
32. Napisz funkcję `equalLength`, która porównuje dwie listy bez głowy o elementach typu:
...
33. Napisz funkcję `equalOddSum`, która przyjmuje dwie listy z głową o elementach typu:
...
34. Napisz funkcję `equalEvenSum`, która przyjmuje dwie listy bez głowy o elementach typu:
...
35. Napisz funkcję `sumOddWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
36. Napisz funkcję `doublePositive`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
37. Napisz funkcję `addTwoFirstWithHead`, która przyjmuje jako argument listę z głową o elementach typu:
...
38. Napisz funkcję `addTwoFirstWithoutHead`, która przyjmuje jako argument listę bez głowy o elementach typu:
...
39. Napisz funkcję `absAllWithoutHead`, która otrzymuje jako argument listę bez głowy o elementach typu:
...
40. Napisz funkcję `absAllWithHead`, która otrzymuje jako argument listę z głową o elementach typu:
...
41. Napisz funkcję `countEqual`, która przyjmuje jako argument listę z głową o elementach typu:
